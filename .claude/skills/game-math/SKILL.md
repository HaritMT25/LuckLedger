...
## Demon Seal — Pre-Allocated Pool (Point Accumulation)

6 seals, each gold (2 pts), silver (1 pt), or broken (0 pts). Score T = 2G + S, range 0..12.

**RTP is fixed by the pool, not by per-seal odds.** Tickets are pre-allocated: the PoolContract
tier counts decide how many tickets pay each prize. The populator then *constructs* six seals to
hit the predetermined point total for a ticket's prize (enumerate (g,s,b) with 2g+s=T, g+s+b=6;
pick uniformly) — it does NOT sample seals independently. So the table below is the designed pool
prize distribution (fraction of tickets per tier); it sums to 1.0 and yields ~64.4% RTP on a $5
ticket. (An independent-seal model with P(gold)=0.12/P(silver)=0.40 would give ~146% with this
ladder and is NOT how the mechanic works.)

| T | P(T) | 1-in | Tier | Prize | EV |
|---|------|------|------|-------|-----|
| 0-3 | 0.56708 | 1.76 | Escapes | $0 | $0 |
| 4 | 0.2010 | 5.0 | Consolation | $2 | $0.402 |
| 5 | 0.1367 | 7.3 | Sealed-S | $4 | $0.547 |
| 6 | 0.0664 | 15 | Sealed-M | $10 | $0.664 |
| 7 | 0.0226 | 44 | Sealed-L | $25 | $0.565 |
| 8 | 0.00532 | 188 | Killed-S | $100 | $0.532 |
| 9 | 0.000816 | 1225 | Killed-M | $300 | $0.245 |
| 10-11 | 0.0000791 | 12.6k | Killed-E | $2500 | $0.198 |
| 12 | 0.00000299 | 335k | Killed-L | $25000 | $0.075 |
| **Sum / RTP** | **1.00000** | | | | **$3.227 → ~64.4%** |

Constructive(T): enumerate (g,s,b) where 2g+s=T, g+s+b=6. Pick one (uniformly).
